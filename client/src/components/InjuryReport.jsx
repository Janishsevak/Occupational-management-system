...
function InjuryReport() {
  ...
  const handleFileChange = async (event) => {
    ...
    try {
      await axios.post(
        `${import.meta.env.VITE_BASE_URL}/api/v1/injurydata/uploadinjurydata`,
        formdata,
        {
          headers: {
            "Content-Type": "multipart/form-data",
      ...
      <div className="w-full flex items-center mt-1">
        ...
        <div className="flex w-[30%] justify-end items-center">
          ...
          <button
            ...
            className="bg-emerald-500 text-white px-4 py-2 rounded-lg  ml-4 hover:bg-cyan-800"
          >
            Upload Data
          </button>
          <input
        ...
        {showGraph && (
          <div className="fixed inset-0 bg-gray-500 bg-opacity-50 flex justify-center items-center z-50">
            <div className="bg-white p-6 rounded shadow-lg h-[93%] w-[95%]">
              ...
              <div className="items-center flex justify-center mb-4 gap-3 flex-wrap">
                <button
                  className={
                ...
                <button
                  className={
                    graphType === "injurywise"
                      ? "w-40 text-black px-4 py-2 rounded-lg bg-blue-500"
                      : "w-40 text-black px-4 py-2 rounded-lg bg-gray-300"
                  }
                  onClick={() => setGraphType("injurywise")}
                >
                  By Injury
                </button>
                <button
                  ...
                  onClick={() => setGraphType("department")}
                >
                  By Department
                </button>
              </div>
                ...
                <ResponsiveContainer width="80%" height="80%">
                  {graphType === "contractor" ? (
                    ...
                    >
                      ...
                      <Tooltip />
                      <Legend />
                      <Bar dataKey="count" name="Total Persons" fill="#8884d8">
